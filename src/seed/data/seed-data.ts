...
interface SeedData { users:SeedUser[], products: SeedProduct[]; }

export const initialData: SeedData = {

	users: [
		{
			email: "jomiantoca-2011@hotmail.com",
			fullName: "Josehf Miguel Angel Torres Carrillo",
			password: bcrypt.hashSync( "Holamundo729", 10 ),
			roles: [ "admin" ]
		},
		{
			email: "jomiantoca-2014@hotmail.com",
